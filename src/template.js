              ...
              <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
                ...
                <body>
                  ...
                  <section>
                    ...
                    ${teamMembers.filter((employee) => employee.getRole() === "Manager").forEach(generateCard)}
                    ${teamMembers.filter((employee) => employee.getRole() === "Engineer").forEach(generateCard)}
                    ${teamMembers.filter((employee) => employee.getRole() === "Intern").forEach(generateCard)}
                  </div>
                  </section>
